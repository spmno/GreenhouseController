...
{
	HumiTempRsltEnum	enRslt = HumiTempRslt_Failure;
	...
	if ( (HumiTempRslt_Success == enRslt) && pstHumiTempInfo )
	{
		pstHumiTempInfo->u8Humi = u8HumiH;
	}

	if ( (HumiTempRslt_Success == enRslt) && pstHumiTempInfo )
	{
		pstHumiTempInfo->u8Temp = u8TempH;
	}
